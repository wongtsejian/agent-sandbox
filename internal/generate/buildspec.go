...
type GatewaySpec struct {
	BuildImage string // Docker image for compilation (e.g. "golang:1.24-alpine")
...
// BridgeSpec defines how the bridge runtime is built and configured.
// Injected into Generator by the CLI — generator doesn't own these details.
type BridgeSpec struct {
	...
	EntryPoint string // runtime entry point (e.g. "node /opt/bridge/dist/index.js")
}
